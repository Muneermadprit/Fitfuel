...
//       .then(response => {
//         if (response.data.status && response.data.data) {
//           // Process the meals data into categories
...
//             if (meal.categoryDetails && meal.categoryDetails.length > 0) {
//               meal.categoryDetails.forEach(category => {
...
//                   id: meal._id,
//                   name: meal.mealName,
//                   calories: meal.moreDetails?.energy || 0,
//                   protein: meal.moreDetails?.protein || 0,
//                   carbs: meal.moreDetails?.carbohydrates || 0,
//                   fat: meal.moreDetails?.fat || 0,
//                   image: meal.image && meal.image.length > 0 ? meal.image[0] : "https://source.unsplash.com/500x300/?food",
...
//   // Define default categories if API doesn't return any
//   const defaultCategories = [
//     { id: "balanced", label: "Balanced", icon: <FaUtensils />, color: "from-lime-600 to-lime-800" },
//     { id: "protein", label: "High Protein", icon: <FaDrumstickBite />, color: "from-blue-500 to-blue-700" },
//     { id: "vegan", label: "Vegan", icon: <FaLeaf />, color: "from-green-500 to-green-700" },
//     { id: "lowcarb", label: "Low Carb", icon: <FaSeedling />, color: "from-purple-500 to-purple-700" },
//     { id: "keto", label: "Keto", icon: <FaFire />, color: "from-orange-500 to-orange-700" }
//   ];
...
//               className={`w-full py-2 rounded-xl font-bold text-lg shadow-lg transition-all ${
//                 acceptedTerms 
